...
<section class="productos">
    ...
    <div class="producto">
        <img src="botasyaquizzchocolate.jpg" alt="imagenes del producto">
        <h3>Botas Yaquiz</h3>
        <h5>Talla 25.5</h5>
        <p>Q1,150.00</p>
    ...
    <div class="producto">
        <img src="botacheyennee.jpg" alt="imagenes del producto">
    ...
    <div class="producto">
        <img src="botaelmalcreado.jpg" alt="imagenes del producto">
